...
#  - Set environment variables only for stg
# ---------------------------------------------
...
DEV_ENV="stg"
OPTIMIZE_ARTIFACT_REPO="airux8-optimize-repo-stg"
...
BUCKET_NAME="airux8-opti-logic-stg"
...
# --- 3) Set env variables for STG environment only ---
